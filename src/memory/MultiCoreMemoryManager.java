...
public interface MultiCoreMemoryManager {
	 ...
	 *
	 * @param process
	 *            the process that needs memory allocated
	 ...
	 *
	 * @param process
	 *            the process to free all of it's memory
	 ...
	 *            process to load
	 * @param cpu
	 *            the CPU on which to load the process
	 * @return true if loading was successful
	 */
	boolean load(Process process, Core core);
