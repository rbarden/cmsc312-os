...
public class GUIPanel extends JPanel {
	...
	/*
	 * This method updates the Ready Queue table to accurately reflect its
	 * current state.
	 */
	public void updateReadyQueueTable(ArrayList<Process> pArr) {
		...
		dTMInputQueue = new DefaultTableModel(data, headers);
		readyQueueTable.setModel(dTMInputQueue);
	}

	/*
	 * This method updates the Waiting Queue table to accurately reflect its
	 * current state.
	 */
	public void updateWaitingQueueTable(ArrayList<Process> pArr) {
		String[] headers = { "Process: ", "State: ", "Arrival: " };
		String[][] data = new String[50][3];
		for (int i = 0; i < 50; i++) {
		...
		dTMWaitingQueue = new DefaultTableModel(data, headers);
		waitingQueueTable.setModel(dTMWaitingQueue);
	}

	/*
	 * This method updates the Finished Queue table to accurately reflect its
	 * current state.
	 */
	public void updateFinishedQueueTable(ArrayList<Process> pArr) {
		String[] headers = { "Process: ", "State", "Arrival: " };
		String[][] data = new String[50][3];
		for (int i = 0; i < 50; i++) {
		...
		dTMFinishedQueue = new DefaultTableModel(data, headers);
		finishedQueueTable.setModel(dTMFinishedQueue);
	}
